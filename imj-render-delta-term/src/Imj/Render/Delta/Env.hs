...
import           Imj.Render.Delta.Console
import           Imj.Render.Delta.Draw
import           Imj.Render.Delta.Flush
import           Imj.Render.Delta.DefaultPolicies
...
-- | Creates an environment using default policies (see "Imj.Render.Delta.DefaultPolicies").
